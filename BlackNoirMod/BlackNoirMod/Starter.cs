...
namespace Starter
{
    public class Mod
    {
        private const string MOD_ENTRY = "BlackNoir.Mod";
        private const string MOD_DLL_NAME = "BlackNoir.dll";
...
// Originally uploaded by 'Shottz_'. Do not reupload without their explicit permission.
